...
use super::{runner::Algorithm, creature_chromosome::CreatureChromosome};
...
impl Plugin for GeneticAlgorithmPlugin {
    fn build(&self, app: &mut AppBuilder) {
        app
            .insert_resource(Algorithm::<CreatureChromosome>::default())
...
fn setup_genetic_algorithm(mut ga: ResMut<CreatureGA>, mut start_evaluating_events: EventWriter<StartEvaluatingEvent>) {
...
fn genetic_algorithm_system(mut ga: ResMut<CreatureGA>, mut start_evaluating_events: EventWriter<StartEvaluatingEvent>) {
...
fn count_finished_evaluating(mut finished_evaluating_events: EventReader<FinishedEvaluatingEvent>, mut ga: ResMut<CreatureGA>) {
